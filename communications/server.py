            ...
            try:
                ...
                if received_messages:
                    ...
                    for received_message in build_messages(received_messages):
                        ...
                        received_message = literal_eval(received_message)
    ...
    def interpret(self, sender_ip, sender_port, message_dict):
        ...
        if command == 'host_game':
            ...
            if game_id not in active_games:
                ...
                response_dict = {"command": "player_joined", "players": clients_to_notify, "nicknames": self.nicknames_for_clients}
                return response_dict, clients_to_notify

        elif command == 'start_game':
            # Tell all players in a room that a game has started
            clients_to_notify = self.clients_by_rooms[game_id]
            response_dict = {"command": "start_game", "player_who_owns_turn": clients_to_notify[0], "players": clients_to_notify}
            return response_dict, clients_to_notify
